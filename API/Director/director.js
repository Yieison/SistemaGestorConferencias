...
function cargarInformacion(){
   ...
   document.getElementById("rolUsuarioDir").innerHTML="CHAIR"

    document.getElementById("codigoUsuarioDir").innerHTML=usuario.apellido
    document.getElementById("cedulaUsuarioDir").innerHTML=usuario.documento
