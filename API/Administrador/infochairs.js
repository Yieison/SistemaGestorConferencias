...
function mostrarListadoChairs() {
    findListChairs()
        ...
        .then(data => {
            ...
            document.getElementById("tablaChairs").innerHTML = body;

            // Mostrar la sección de evaluadores
            document.getElementById("section-chairs").style.display = 'none';
        })
        .catch(e => {
            console.log(e);
        });
